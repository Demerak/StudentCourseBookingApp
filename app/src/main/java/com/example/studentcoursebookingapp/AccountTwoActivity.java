...
// todo refactor
public class AccountTwoActivity extends AppCompatActivity {
    ...
    private View.OnClickListener openHomePageActivity = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Intent intent = new Intent(AccountTwoActivity.this, HomeActivity.class);
...
//                });
                ...
                dbUser.document(accountList.get(0).getId()).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(AccountTwoActivity.this, "Success!", Toast.LENGTH_LONG).show();
            ...
            dbUser.whereEqualTo("name", username).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                ...
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(AccountTwoActivity.this, Integer.toString(task.getResult().size()), Toast.LENGTH_LONG).show();

                        for (QueryDocumentSnapshot document: task.getResult()) {
                            Toast.makeText(AccountTwoActivity.this, document.getData().toString() , Toast.LENGTH_SHORT).show();
